...
API_KEY = "sk-xxx"    # 可同时填写多个API-KEY，用英文逗号分割，例如API_KEY = "sk-openaikey1,sk-openaikey2,fkxxxx-api2dkey3,azure-apikey4"
# 对于chatGPT，需要在用户中心生成API密钥：https://platform.openai.com/api-keys
